package com.g3.batch.slxdb2fileleaj0008tasklet.service;

import com.g3.batch.slxdb2fileleaj0008tasklet.model.Leaj0008ParameterModel;
import com.g3.batch.slxdb2fileleaj0008tasklet.model.Leaj0008StructureMastModel;
...
public class Leaj0008Service {
    ...
    protected void setParameter(Leaj0008ParameterModel pm, Map<String, Object> map) {
        ...
        if ( map.get("outf") != null ) {
            // 構成マスターファイル
            pm.setProdStrcFile(map.get("outf").toString());
        }
    ...
    protected void structureMastFileOutputProcess(Leaj0008ParameterModel pm, ResultSet result, String outputFile) throws Exception{
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile, false))) {
            Leaj0008StructureMastModel model = null;
...
//                              + padSpaseRight(StringUtil.padZeroLeft(StringUtil.trimString(model.getStructureSeq()), 3), 3)  //構成連番 2014/08/19 廃止
     ...
     */
    public Leaj0008StructureMastModel convertResultStructureMastModel(ResultSet result) throws Exception{

        Leaj0008StructureMastModel model = new Leaj0008StructureMastModel();
